...
async def run_test():
    ...
    try:
        ...
        # -> Enter provided credentials into the username and password fields and click 'Sign in' to authenticate.
        ...
        # -> Attempt second (final allowed) sign-in by filling username and password fields and clicking Sign in. Then wait for the app to navigate and check for access to /sales/invoices (if navigation occurs).
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=html/body/div/div[2]/div[1]/form/div[1]/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('Rop')
