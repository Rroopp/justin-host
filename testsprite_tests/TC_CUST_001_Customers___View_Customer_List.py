...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: Expected to verify that the customers list page loads and displays the 'Customers' heading and customer details, but the expected text was not visible within the timeout — the customers list or customer details did not appear.")
        ```
