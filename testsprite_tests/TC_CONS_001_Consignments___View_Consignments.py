...
async def run_test():
    ...
    try:
        ...
        # -> Fill the Username and Password fields using the provided credentials and click the Sign in button to authenticate.
        ...
        # -> Click the 'Surgery Consignments' sidebar link using the indexed interactive element to open the consignments list (use element index 243).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=html/body/div/aside/div/div[2]/div/nav/a[12]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
