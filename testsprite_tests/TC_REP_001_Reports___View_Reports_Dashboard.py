...
async def run_test():
    ...
    try:
        ...
        # -> Fill username and password and submit the login form to attempt authentication (then proceed to navigate to /reports).
        ...
        # -> Click the 'Reports & AI' link in the left sidebar to open the reports dashboard (use element index 278).
        frame = context.pages[-1]
        # Click element
