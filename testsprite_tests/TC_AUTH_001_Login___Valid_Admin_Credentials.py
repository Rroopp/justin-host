...
async def run_test():
    ...
    try:
        ...
        # -> Enter admin username and password into inputs (indexes 46 and 50) and click the Sign in button (index 59).
        ...
        # -> Fill the username and password fields with admin credentials and click the Sign in button to attempt login (second attempt), then observe whether the browser redirects to /dashboard.
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=html/body/div/div[2]/div[1]/form/div[1]/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('Rop')
