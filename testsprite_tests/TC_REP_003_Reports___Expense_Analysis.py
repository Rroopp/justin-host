...
async def run_test():
    ...
    try:
        ...
        # -> Fill the username and password fields and submit the login form using admin / admin123, then proceed to the reports page if login succeeds.
        ...
        # -> Open the Reports & AI menu to access reports (click element index 620).
        frame = context.pages[-1]
        # Click element
