...
async def run_test():
    ...
    try:
        ...
        # -> Fill the username and password fields using the visible interactive inputs and click the Sign in button to attempt authentication (use indexes [336], [340], [349]).
