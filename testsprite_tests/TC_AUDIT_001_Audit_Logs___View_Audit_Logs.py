...
async def run_test():
    ...
    try:
        ...
        # -> Fill the username and password fields and click the 'Sign in' button to log in as admin.
        ...
        # -> Click the sidebar 'Settings' link (index 513) to open Settings and locate the Audit Logs page.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=html/body/div/aside/div/div[2]/div/nav/a[25]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
