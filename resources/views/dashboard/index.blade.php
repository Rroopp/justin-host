...
<div class="px-4 py-4 sm:px-0">
    ...
    <div x-data="dashboardData()" x-init="init()" class="space-y-4">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            @else
            <!-- Staff: My Transactions Count (Month) -->
            <div class="bg-white overflow-hidden shadow-sm rounded border border-gray-200 p-4 flex items-center">
                ...
                <div>
                    <dt class="text-xs font-medium text-gray-500 truncate">Your Txns (Month)</dt>
                    <dd class="text-lg font-bold text-gray-900 leading-none" x-text="data.sales_count_month || 0"></dd>
                    <span class="text-xs text-gray-400">Completed Sales</span>
                </div>
            </div>
            @endif
            ...
            @else
            <!-- Staff: My Monthly Revenue -->
            <div class="bg-white overflow-hidden shadow-sm rounded border border-gray-200 p-4 flex items-center">
                <div class="p-2 rounded bg-purple-50 text-purple-600 mr-3">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                </div>
                <div>
                    <dt class="text-xs font-medium text-gray-500 truncate">Your Mo. Sales</dt>
                    <dd class="text-lg font-bold text-gray-900 leading-none" x-text="formatCurrency(data.month_revenue || 0)"></dd>
                    <span class="text-xs text-gray-400" x-text="new Date().toLocaleString('default', { month: 'short' })"></span>
                </div>
            </div>
...
window.dashboardData = function() {
    return {
        data: {
            ...
            sales_count_month: {{ $monthSalesCount ?? 0 }}
        },
        loading: false,
        salesChart: null,
        paymentChart: null,
