...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="hidden print:block mb-8">
        ...
        <!-- Report Title Section (Like Invoice Title) -->
        <div class="text-center mb-8">
            <h2 class="text-2xl font-bold text-indigo-800 uppercase tracking-wider mb-2">Deep Compounded Analysis</h2>
            <div class="flex justify-center items-center gap-8 text-sm font-medium text-gray-600">
                <div>PERIOD: <span class="text-gray-900">{{ $start_date->format('d M Y') }} - {{ $end_date->format('d M Y') }}</span></div>
                <div>GENERATED: <span class="text-gray-900">{{ now()->format('Y-m-d H:i') }}</span></div>
            </div>
        </div>
    </div>
