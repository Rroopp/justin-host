    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-md">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tfoot class="bg-gray-50 border-t-2 border-gray-300">
                <tr>
                    <td colspan="3" class="px-6 py-3 text-right text-xs font-bold text-gray-900 uppercase">Totals</td>
                    <td class="px-6 py-3 text-right text-xs font-bold text-gray-900 uppercase" x-text="formatCurrency(totalDebits)"></td>
                    <td class="px-6 py-3 text-right text-xs font-bold text-gray-900 uppercase" x-text="formatCurrency(totalCredits)"></td>
                </tr>
            </tfoot>
        </table>
    </div>
