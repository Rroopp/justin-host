                                        ...
                                        <td colspan="7" class="px-4 py-12">
                                            <div class="flex flex-col items-center justify-center">
                                                ...
                                                <p class="text-xs text-gray-500 mb-3 text-center">
                                                    No logs match your current filters. Try adjusting your date range or clearing filters.
                                                </p>
                                                <button @click="clearFilters()" class="inline-flex items-center px-3 py-1.5 border border-gray-300 rounded-md text-xs font-medium text-gray-700 bg-white hover:bg-gray-50">
                                                    Clear Filters
                                                </button>
                                            </div>
                                        </td>
